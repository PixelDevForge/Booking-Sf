...
class RegisterType extends ApplicationType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('hash',PasswordType::class,$this->getConfiguration('mot de passe','Un password'))
            ->add('passwordConfirm',PasswordType::class,$this->getConfiguration('Confirmation de votre mdp','Un password'))
            ->add('introduction',TextType::class,$this->getConfiguration('Introduction','Presentez vous'))
            ->add('description',TextareaType::class,$this->getConfiguration('Description','Description détaillé'))
